const words = {
    "grade_1": {
        ...
        "Nouns": ["Time", "Person", "Year", "Way", "Day", "Thing", "Man", "World", "Life", "Hand", "Part", "Child", "Eye", "Woman", "Place", "Work", "Week", "Case", "Point", "Government", "Company", "Number", "Group", "Problem", "Fact", "Be", "Have", "Do", "Say", "Get", "Make", "Go", "Know", "Take", "See", "Come", "Think", "Look", "Want", "Give", "Use", "Find", "Tell", "Ask", "Work", "Seem", "Feel", "Try", "Leave", "Call", "Good", "New", "First", "Last", "Long", "Great", "Little", "Own", "Other", "Old", "Right", "Big", "High", "Different", "Small", "Large", "Next", "Early", "Young", "Important", "Few", "Public", "Bad", "Same"],
        ...
        "Animal": ["Dog", "Cat", "Bird", "Fish", "Lion", "Tiger", "Elephant", "Monkey", "Giraffe", "Zebra", "Horse", "Cow", "Pig", "Sheep", "Goat", "Chicken", "Duck", "Goose", "Rabbit", "Turtle", "Snake", "Frog", "Crocodile", "Shark", "Whale", "Dolphin", "Octopus", "Jellyfish", "Starfish", "Crab", "Lobster", "Shrimp", "Squid", "Oyster", "Clam", "Mussel", "Snail", "Slug", "Butterfly", "Bee", "Ant", "Mosquito", "Fly", "Dragonfly", "Grasshopper", "Beetle", "Ladybug", "Caterpillar", "Worm", "Spider", "Scorpion", "Centipede", "Millipede", "Cockroach", "Termite", "Bedbug", "Flea", "Louse", "Tick", "Mite", "Cricket", "Locust", "Moth"],
    }
}

function setQuestion() {
    // get random word from words.grade_1 based on the checked radio button group
